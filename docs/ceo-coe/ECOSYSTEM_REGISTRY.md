...
| gtop-app | Growth Tutorials product | `F:\Workspace\Programs\Growth-Tutorials\gtop-app` | `https://github.com/Wolfrine/gtop-app.git` | `main` | dirty | Active GTOP app repo; inspect dirty work before changes. |
